...
public class Utils {
	 ...
	 *
	 * @param array
	 *            array of items to join.
	 * @param delimiter
	 *            delimiter to insert between elements of array.
	 * @return string with array elements separated by delimiter. There is no
	 *         trailing delimiter in the string.
	 */
	...
	/**
	 * Splits a string into an array using provided delimiters. Empty (but not
	 * blank) split chunks are omitted. The split chunks are trimmed.
	 *
	 * @param input
	 *            string to split.
	 * @param delimiters
	...
	/**
	 * Splits a string into an array using provided delimiter. Empty (but not
	 * blank) split chunks are omitted. The split chunks are trimmed.
	 *
	 * @param input
	 *            string to split.
	 ...
	 * @return string with collection elements separated by delimiter. There is
	 *         no trailing delimiter in the string.
	 */
	...
	/**
	 * Joins the items in collection with a delimiter, and appends the result to
	 * StringBuilder.
	 *
	 * @param sb
	...
	/**
	 * Joins the items in array with a delimiter, and appends the result to
	 * StringBuilder.
	 *
	 * @param sb
	 *            StringBuilder to append result to
	...
	/**
	 * Repeats string of characters a defined number of times, and appends
	 * result to StringBuilder.
	 *
	 * @param sb
	 *            StringBuilder to append result to
	 * @param str
	 *            string of characters to be repeated.
	 * @param count
	 *            number of times to repeat, zero or a negative number produces
	 *            no result
	 */
	...
	public static String getPageSql(String sql, String dialect, PageRow pageRow) {
		...
		if ("mysql".equalsIgnoreCase(dialect)) {
			pageSql.append(sql);
			if (StringKit.isNotBlank(pageRow.getOrderBy())) {
