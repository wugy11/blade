...
public class EncrypKit {
    ...
    public static String md5(byte[] data, byte[] salt) {
        ...
        byte[] dataSalt = new byte[dataLen + saltLen];
        System.arraycopy(data, 0, dataSalt, 0, dataLen);
        System.arraycopy(salt, 0, dataSalt, dataLen, saltLen);
    ...
    public static byte[] encryptMD5File(File file) {
        ...
        try {
            ...
            digestInputStream = new DigestInputStream(fis, MessageDigest.getInstance("MD5"));
    ...
    public static byte[] desTemplate(byte[] data, byte[] key, String algorithm, String transformation,
        ...
        try {
            ...
            cipher.init(isEncrypt ? Cipher.ENCRYPT_MODE : Cipher.DECRYPT_MODE, keySpec, new SecureRandom());
