...
public class AsonSerializeTest {
	...
	public void test_auto_deserialize_primitive() {
		// This happens if you use the variation of get() that takes a class
	...
	public void test_get_list_on_object() {
		...
		try {
			...
			assertFalse("No exception thrown when using getList() for a " + "key that represents a non-array!", false);
		} catch (IllegalStateException ignored) {
		}
	}
